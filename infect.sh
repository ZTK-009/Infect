# A tool by nitro from www.mrlinkerrorsystem.blogspot.com
...
echo -e "$red                      ▶ Coded by$grn ROBOT Pace Usa$red ◀$rset"
echo -e "$red                 ⫸$ylo mrlinkerrorsystem.blogspot.com$red ⫷$rset"
echo 
# Functions
